...
public class StartCommandTests
{
    public StartCommandTests()
    {
        ...
        IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Game.QueuePush", (object[] args) => mockStrategyReturnsCmd.Object.RunStrategy(args)).Execute();


    }

    [Fact]
    public void StartCommandPositiveTest()
    {
